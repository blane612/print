...
print('Brielle')
print('June','12th')
print('Saweetie - Back to the Streets')
print()
...
print('Alba' + 'vania')
print()
print('like you, like you (oh)')
print('I found it hard to find someone like you')
print('Like you, like you')
print('Send your location come through')
